...
## Motivations 
- Puis-je **réutiliser** un **bout de code** trouvé sur **StackOverflow**, **GitHub** ou **généré par Claude Code** ?
...
---
## La preuve d'antériorité par blockchain en 2026
...
* En France : mode de preuve libre, un juge peut la considérer comme indice technique sérieux mais pas plus qu'un log ou un courriel.
...
* Droit d'auteur : avant tout protection des **auteurs et leur œuvres**.
* Copyright : avant tout protection de l'**exploitation économique des œuvres**.
* Peu ou pas de droits moraux sur le copyright contrairement au droit d'auteur.
    
---

## La convention de Berne

* Convention pour la protection des œuvres littéraires et artistiques (1886, dernière révision en 1979), ratifiée par 181 états en 2026.
...
* Administrée aujourd'hui par l'Organisation mondiale de la propriété intellectuelle (ONU, Genève).
...
* Peut donner des droits aux utilisateurs (licences Open Source) ou rappeler les limitations d'usage (CLUF).
...
* le jour où le code sort (vente, open source, SaaS), **tout l’historique devient juridiquement pertinent**.
...
* 2000-2010 environ : Iliad/Free utilise du code GPL dans la Freebox, pression communauté, publication vers ~2010 du code de freebox.fr par exemple.
...
* Le code source n'est pas disponible (sauf exceptions contractuelles et même dans ce cas, le code n'est pas FLOSS).
    
---

### Les CLUF et GCU

* Genre de licences mais orientée uniquement vers les utilisateurs finaux et donne surtout des limitations d'usage. 
...
### Différences CLUF et CGU (Conditions Générales d'Utilisation)
...
* Années 1970/1980 : 
    ...
    - 1976: Bill Gates demande de cesser «&nbsp;le vol&nbsp;» des logiciels.
...
* Rapidement très technique et complexe : 
    - Quid des machines virtuelles ? des containers ?
...
### Différence Libre et Open Source ?

* **Logiciel libre : centré sur les libertés de l’utilisateur** (utiliser, étudier, modifier, redistribuer).
* **Open source : centré sur l’accès au code et les bénéfices pratiques** (qualité, collaboration, adoption industrielle).
* Origine :
    * Libre → Free Software Foundation (vision éthique).
    * Open source → Open Source Initiative (vision pragmatique).
* Différence principale : Libre → philosophie (liberté), Open source → méthodologie (efficacité).
...
* Il est aussi possible (**bien que très fortement déconseillé**) d'intégrer du code GPL dans un logiciel **interne** de licence incompatible (propriétaire par exemple) à condition de ne pas distribuer ce logiciel.
...
* BSD: interdiction d’utiliser le nom des auteurs pour promouvoir.
* Apache : clause anti-agression par brevets (un contributeur accorde ses brevets, si action en contrefaçon de brevet logiciel → résiliation automatique de la licence).
<div class='admonition note'>
...
### Exemple simplifié SBOM CycloneDX avec licences
...
### GPL + exception vs LGPL

* **LGPL** : licence standard “copyleft faible”  
  → utilisation dans logiciel propriétaire autorisée, règles fixes  

* **GPL + exception (ex : GNU Classpath)** :  
  → même effet (utilisation autorisée) mais **règles personnalisables par l’auteur**  

* **Différence clé** :
  * LGPL → compromis générique  
  * GPL + exception → contrôle fin (limitation des usages) et évolutif  (on peut retirer l'exception dans certains cas)


> 💡 “LGPL = standard, GPL + exception = sur-mesure”

---

### Les licences orientées contenu : La GFDL
...
### Les licences orientées contenu : Les licences Creative Commons
...
* Essentiellement utilisée par l'état français pour ses données **Open Data**.  
* Très permissive, seule obligation : **attribution/paternité (citer la source)**  
* Autorise :
  * réutilisation libre (y compris commerciale)
  * modification et redistribution  

👉 Objectif : **maximiser la réutilisation et la diffusion**

#### Exemples d’usage
* API publiques (ex : API Entreprise, API Adresse)  
* Jeux de données sur data.gouv.fr (transport, météo, finances publiques…)  
* Données INSEE, IGN (en partie), collectivités locales  

<div class='admonition note'>
Les administrations peuvent utiliser d'autres licences, liste officielle <a href='https://www.data.gouv.fr/fr/pages/legal/licences/'>ici</a>.</div>

---

### Les licences orientées contenu : la licence ODbL v1.0
* Géré par l'Open Knowledge Foundation (internationale, fondée UK)
* Licence de base de données avec **copyleft**  
* Obligation de :
  * partager les améliorations  
  * conserver la même licence (share alike)  
* Peut imposer le partage si la base est enrichie ou redistribuée  

👉 Objectif : **construire un commun et empêcher l’appropriation privative**
...
* La propriété du code généré dépend : 
  - des CGU : prévoient en général que le code appartient à l'utilisateur mais la propriété peut être partagée (ex: Midjourney) ou limitée (OpenIA : droit d'usage).
...
* Réglementation européenne adoptée en 2024, ratifié en France mais application sur 2025-2027.
